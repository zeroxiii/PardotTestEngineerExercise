...
public class PardotTest 
{
	...
	public void test01ValidLogin() 
	{
		...
		try
		{
			block.until(ExpectedConditions.titleIs("Dashboard - Pardot"));
	...
	public void test02CreateOriginalList()
	{
		...
		System.out.print("Step 2: Creating a list with a random Name - ");
		...
		try
		{
			...
			block.until(ExpectedConditions.titleIs(originalListName + " - Pardot"));
			System.out.println("Successful");
		}
		catch (Throwable t)
		{
	...
	public void test03CreateDuplicateList()
	{
		...
		System.out.print("Step 3: Creating a list with a used name - ");
	...
	public void test04RenameListAndRecreatOriginalList()
	{
		...
		System.out.print("Step 4: Rename original list - ");
		...
		try
		{
			...
			block.until(ExpectedConditions.titleIs(originalListName + "new" + " - Pardot"));
		...
		System.out.print("Step 5: Recreate a list with original name - ");
	...
	public void test05CreateProspectAndAddToListAndVerify()
	{
		...
		System.out.print("Step 6: Create a new prospect - ");
		...
		try
		{
			...
			block.until(ExpectedConditions.titleIs(prospectEmail + " - Pardot"));
			System.out.println("Successful");
		}
		catch (Throwable t)
		{
		...
		System.out.print("Step 7: Add Prospect to list - ");
		...
		System.out.print("Step 8: Verify prospect is added to list - ");
	...
	{
		System.out.print("Step 9: Create and send text only email to created list - ");
		
		// Attempt to create and send email to the created list
		try
		{
			// Navigate to Marketing -> Emails and wait for new email dialog to appear
			...
			// Since email permissions are not in place, return back to dashboard
			driver.get(pardotURL);
	...
	public void test07ValidLogout()
	{
		...
		System.out.print("Step 10: Logout - ");
